...
import { createBuyer } from "./hook/createBuyer";
  ...
  return (
    <div>
      <button
        ...
        className="top-20 bg-green-600 text-white px-4 py-2 rounded-md shadow-md hover:bg-green-700 text-sm"
      >
        Create Buyer
      </button>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
            ...
            <h1 className="text-lg font-bold text-green-700 mb-4">
              Buyer Registration
            </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  value={formData.cropNames.map((name: string) => ({
                    value: name,
                    label: name,
                  }))}
                          ...
                          <div className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full flex items-center gap-1">
                            ...
                            <button
                              ...
                              onClick={() => {
                                setFormData((prev) => ({
                                  ...prev,
                                  cropNames: prev.cropNames.filter(
                                    (c) => c !== cropName
                                  ),
                                }));
                                setPrices((prev) =>
                                  prev.filter((p) => p.cropName !== cropName)
                                );
                              }}
